...
int main(int argc, char *argv[]) {
  ...
  bool usingConv2 = (argc > 4 && (strcmp(argv[4], "conv2") == 0));
  ...
  // Build Lenet5 model
  Network dnn;
  Layer* conv1 = new Conv(1, 28, 28, 6, 5, 5, 1, 0, 0, usingDevice, usingConv2);
  Layer* pool1 = new MaxPooling(6, 24, 24, 2, 2, 2);
  Layer* conv2 = new Conv(6, 12, 12, 16, 5, 5, 1, 0, 0, usingDevice, usingConv2);
